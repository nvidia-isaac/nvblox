...
.. code-block:: bash
    ...
    build/executables/fuse_3dmatch sun3d-mit_76_studyroom-76-1studyroom2 mesh.ply
...
.. code-block:: bash
    ...
    build/executables/fuse_redwood ~/datasets/redwood/apartment --voxel_size=0.02 mesh.ply
