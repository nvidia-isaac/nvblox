...
* GPU accelerated agorithms such as:
  * TSDF construction
  * ESDF construction
* ROS2 interface (see [issac_ros_nvblox](https://gitlab-master.nvidia.com/isaac_ros/isaac_ros_nvblox))
...
![slice](/uploads/c719a12a65cb1e6211645d6a8ce5fc37/slice.gif)

### Note from authors
We're in the process of putting this library together to help us with visual navigation on autonomous mobile robots. It is far from complete at the moment, we're happy to help if you wanna use it, and we're looking for feedback, suggestions, contributions, and complaints ;). Reach us on slack at holeynikova@nvidia.com and amillane@nvidia.com.

# ROS2 Interface
This repo contains the core library which can be linked into users' projects. If you want to use nvblox on a robot out-of-the-box, please see our [ROS2 interface](https://gitlab-master.nvidia.com/isaac_ros/isaac_ros_nvblox), which downloads and builds the core library during installation.
...
![slice](/uploads/93674f9888eeaa3361c603f1200cb31c/reconstruction_in_docker_trim.png)
