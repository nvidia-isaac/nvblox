...
def run_single(executable_path: str, dataset_base_path: str,
               timing_output_path: str = None, num_frames: int = None,
               flags: Dict = None):
...
def run_multiple(num_runs: int, executable_path: str, dataset_base_path: str,
                 timing_output_dir: str = None, num_frames: int = None,
                 warmup_run: bool = True, flags: Dict = None):
    ...
    for run_idx in run_indices:
        ...
        run_single(executable_path, dataset_base_path,
                   timing_output_path, num_frames, flags)
